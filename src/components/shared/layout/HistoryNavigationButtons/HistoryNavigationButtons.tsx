...
const HistoryNavigationButtons = (props: any) => {
    let leftArrowClassName = 'arrow-icon';
    let rightArrowClassName = 'arrow-icon';

    leftArrowClassName += props.backButtonDisabled ? ' disabled': '';
    rightArrowClassName += props.forwardButtonDisabled ? ' disabled': '';

    return (
        <div id={style.historyNavigationButtons}>
            <button disabled={props.backButtonDisabled}> {/* (click)="navigateBack()" */}
                <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22" className={leftArrowClassName}>
            ...
            <button className={style.forwardButton} disabled={props.forwardButtonDisabled}> {/* (click)="navigateForward()" */}
                <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22" className={rightArrowClassName}>
