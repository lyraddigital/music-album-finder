...
const HistoryNavigationButtons = (props: any) => {
    return (
        <div id={style.historyNavigationButtons}>
            <button disabled={props.backButtonDisabled}> {/* [disabled]="backButtonDisabled" (click)="navigateBack()" */}
            ...
            <button className={style.forwardButton} disabled={props.forwardButtonDisabled}> {/* [disabled]="forwardButtonDisabled" (click)="navigateForward()" */}
                <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22" className="arrow-icon"> {/*  [class.disabled]="disabled" */}
